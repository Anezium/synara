...
Step 1 is the budget table. Every number below is a proposed warm target and is unverified until measured on a warm host on Kartik's machine. Warm means the driver generation already exists and the target app is already running.

| Operation                                          | p50 target | p95 target | Notes                                           |
| -------------------------------------------------- | ---------- | ---------- | ----------------------------------------------- |
| get_state, AX only, warm                           | 400 ms     | 900 ms     | No screenshot; tree walk dominates; unverified  |
| get_state, with screenshot, warm                   | 900 ms     | 1800 ms    | Tree plus 1536 px capture; unverified           |
| click, input plus observation                      | 800 ms     | 1600 ms    | Includes 300 ms settle today; unverified        |
| type, focus neutral AX insert                      | 600 ms     | 1200 ms    | No focus excursion on the AX path; unverified   |
| scroll, single leg                                 | 800 ms     | 1600 ms    | Probe splits pay settle twice today; unverified |
| launch, app already installed                      | 2000 ms    | 5000 ms    | OS cost dominates; unverified                   |
| turn start, warm host, first tool call             | 800 ms     | 2000 ms    | No spawn cost; unverified                       |
| host cold start, spawn plus handshake plus session | 2000 ms    | 5000 ms    | Bounded by the 5 s startup calls; unverified    |
