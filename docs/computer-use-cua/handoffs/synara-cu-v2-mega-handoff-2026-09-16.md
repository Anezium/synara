...
Ours today: list_windows, get_state, screenshot, get_screen_size, wait, click/double/triple/right, move, drag, scroll, type, press/hotkey, set_value, perform_action (AXPress only), paste, read/write clipboard, launch, activate, run batch.
