...
export function computerToolInstructions(): string {
  return [
    ...
    "computer_help carries the chapters this block omits — browser-tab driving, menus/frames/app exits, hidden workspaces, form work, recording and replay — and lists them when called bare. Read the matching topic before touching a surface it covers.",
  ].join("\n");
}
